# Generated by Powerlevel10k configuration wizard on 2026-03-15 at 01:27 UTC.
...
# --- DEFINITIVE P10K THEME ENGINE ---
typeset -ga _THEME_LIST=("retro-terminal" "desert-haze" "nordic-night")
[[ -z $_CURRENT_THEME_IDX ]] && _CURRENT_THEME_IDX=1

function zsh-theme() {
  local cmd=$1
  case $cmd in
    "--next")     (( _CURRENT_THEME_IDX = (_CURRENT_THEME_IDX % ${#_THEME_LIST}) + 1 )) ;;
    "--previous") (( _CURRENT_THEME_IDX = (_CURRENT_THEME_IDX - 2 + ${#_THEME_LIST}) % ${#_THEME_LIST} + 1 )) ;;
    "")           echo "Usage: zsh-theme [theme_name | --next | --previous]"; return ;;
    *)
      local found=0
      for i in {1..${#_THEME_LIST}}; do
        if [[ ${_THEME_LIST[$i]} == "$cmd" ]]; then _CURRENT_THEME_IDX=$i; found=1; break; fi
      done
      [[ $found -eq 0 ]] && { echo "Theme '$cmd' not found."; return }
      ;;
  esac

  local theme_func="_apply_theme_${_THEME_LIST[$_CURRENT_THEME_IDX]//-/_}"
  $theme_func
  echo "Applied Theme: ${_THEME_LIST[$_CURRENT_THEME_IDX]}"
  p10k reload
}

# --- THEME DEFINITIONS ---
function _theme_reset_overrides() {
  typeset -g POWERLEVEL9K_VISUAL_IDENTIFIER_COLOR=inherit
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR=' '
  ...
  typeset -g POWERLEVEL9K_VCS_BACKEND_ICON_COLOR=inherit
}

function _apply_theme_retro_terminal() {
  _theme_reset_overrides
  local amber=214
  ...
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=$amber
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$amber
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=$amber
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=$amber
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=$amber
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=$amber
}

function _apply_theme_desert_haze() {
  _theme_reset_overrides
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=94
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=137
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=180
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=180
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=65
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=108
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=230
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=230
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=52
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=52
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=231
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=0
}

function _apply_theme_nordic_night() {
  _theme_reset_overrides
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=236
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=24
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=67
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=67
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=103
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=147
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=255c
...
# Initialize with Retro Terminal
_apply_theme_retro_terminal
