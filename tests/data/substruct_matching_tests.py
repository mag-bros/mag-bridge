...
SUBSTRUCT_MATCH_TESTS: list[SubstructMatchTest] = [
    ...
    # TODO resolve ring and Cl-CR2-CR2-Cl overlap
    SubstructMatchTest(
        id=205,
    ...
    SubstructMatchTest(
        ...
        description="Cl-CR2-CR2-Cl share three C-C bonds with cyclohexane ring within bicyclic structure, which excludes its assignment.",
    ),
    ...
    # TODO Fix ring/Cl-CR2-CR2-Cl overlap (3 C-C bond overlap)
    SubstructMatchTest(
        id=217,
    ...
    # TODO Fix overlaping cyclohexene and Cl-CR2-CR2-Cl bond types
    SubstructMatchTest(
        id=219,
    ...
    SubstructMatchTest(
        ...
        expected_matches=Counter(
            {"cyclopropane": 2, "cyclobutane": 1, "Br-CR2-CR2-Br": 1, "benzene": 2}
        ),
    ...
    SubstructMatchTest(
        ...
        expected_matches=Counter(
            {"C=N": 1, "C=O": 1, "cyclohexene": 1, "benzene": 1, "C-Br": 4}
        ),
        description="Br-CR2-CR2-Br not allowed when any R = C=O or C=N",
    ),
    SubstructMatchTest(
        id=259,
        SMILES="C1(C(C(=C(C(=C1Br)Br)Br)Br)Br)OC2=C(C(=C(C(=C2Br)Br)Br)Br)Br",
        expected_matches=Counter(
            {"Ar-Br": 5, "C-Br": 5, "Ar-OR": 1, "benzene": 1, "C=C-C=C": 1}
        ),
    ...
    SubstructMatchTest(
        ...
        description="Ar-I and C-I bonds in one molecule.",
    ),
    SubstructMatchTest(
        id=262,
        SMILES="C(C(=O)I)I",
        expected_matches=Counter({"C-I": 2, "C=O": 1}),
        description="C-I if found in RC(=O)I fragment.",
    ),
    SubstructMatchTest(
        id=263,
        SMILES="C(#N)I",
    ...
    SubstructMatchTest(
        ...
        expected_matches=Counter(
            {"benzene": 2, "Ar-I": 2, "Ar-Cl": 1, "RCOOR": 1, "Ar-C(=O)NH2": 1}
        ),
    ),
    SubstructMatchTest(
        id=268,
    ...
    SubstructMatchTest(
        ...
        description="Ar-C#C and C-I assignemnt in Ar-C#C-I fragment.",
    ),
    SubstructMatchTest(
        id=270,
        SMILES="C1=CC=C(C(=C1)C(=O)NCC(=O)[O-])[131I]",
        expected_matches=Counter(
            {"Ar-I": 1, "Ar-C(=O)NH2": 1, "RCOOH": 1, "benzene": 1}
        ),
        description="Bond assignment for isotope-labeled molecule.",
    ),
    SubstructMatchTest(
        id=271,
        SMILES="C1=CC=C(C=C1)[I+]C2=CC=CC=C2",
        expected_matches=Counter({"benzene": 2}),
        description="Ar-I assignment is excluded for hypervalent iodine atom.",
    ),
    SubstructMatchTest(
        id=272,
        SMILES="C(=IF)I=N",
        expected_matches=Counter({}),
        description="C-I assignment is excluded for hypervalent iodine atom.",
    ),
    SubstructMatchTest(
        id=273,
        SMILES="C1=C(C=C(C=C1C#N)F)C#CC2=CSC(=N2)I",
        expected_matches=Counter(
            {"thiazole": 1, "Ar-C#C-Ar": 1, "Ar-I": 1, "-C#N": 1, "benzene": 1}
        ),
    ),
    SubstructMatchTest(
        id=274,
        SMILES="COC1=C(C=CC(=C1)CC=C)O",
        expected_matches=Counter(
            {"Ar-OR": 1, "Ar-OH": 1, "CH2=CH-CH2-": 1, "benzene": 1}
        ),
        description="",
    ),
    ...
    SubstructMatchTest(
        ...
        expected_matches=Counter(
            {"pyrrolidine": 1, "Ar-NR2": 1, "RC(=O)NH2": 1, "benzene": 1}
        ),
    ...
    SubstructMatchTest(
        ...
        description="Triazine derivative.",
    ),
    SubstructMatchTest(
        id=279,
        ...
        description="Ar-NR2 is not matched for NR2 fragment.",
    ),
    SubstructMatchTest(
        id=280,
    ...
    SubstructMatchTest(
        ...
        expected_matches=Counter(
            {"Ar-NR2": 1, "benzene": 2, "Ar-C(=O)NH2": 1, "Ar-Cl": 1}
        ),
    ...
    SubstructMatchTest(
        ...
        description="Ar-C(=O)R is assigned because C=O is not part of the aromatic system.",
    ),
    SubstructMatchTest(
        id=286,
    ...
    SubstructMatchTest(
        ...
        description="Pyrrone is correctly treated as aromatic ring as it is found in aromatic ring system. This implies no Ar-C(=O)R assignment.",
    ),
    SubstructMatchTest(
        id=288,
        SMILES="CCC(=C)C(=O)C1=C(C(=C(C=C1)OCC(=O)O)Cl)Cl",
        expected_matches=Counter(
            {"Ar-C(=O)R": 1, "C=C": 1, "Ar-OR": 1, "Ar-Cl": 2, "RCOOH": 1, "benzene": 1}
        ),
    ...
    SubstructMatchTest(
        ...
        expected_matches=Counter(
            {"piperazine": 1, "Ar-COOH": 1, "Ar-NR2": 1, "benzene": 1}
        ),
        description="Ar-C(=O)R not matched because it is found in oxoquinoline fragment.",
    ),
    SubstructMatchTest(
        id=290,
    ...
    SubstructMatchTest(
        ...
        description="Ar-C(=O)R assignment for aromatic anhydride. Phthalic anhydride.",
    ),
    SubstructMatchTest(
        id=297,
        SMILES="C1=CC2=C(C=C1O)OC3=C2C(=O)OC4=C3C=CC(=C4)O",
        expected_matches=Counter({"pyrones": 1, "furan": 1, "benzene": 2, "Ar-OH": 2}),
        description="furan and pyrones matching in polyaromatic ring system.",
    ),
    SubstructMatchTest(
        id=298,
    ...
    SubstructMatchTest(
        ...
        expected_matches=Counter({"benzene": 1}),
        description="Ar-COOR is not allowed to be matched for fragments with R = Sn.",
    ),
    SubstructMatchTest(
        id=300,
        SMILES="C1=CC=C(C=C1)C(=O)ON=C2C=CC(=NOC(=O)C3=CC=CC=C3)C=C2",
        expected_matches=Counter({"benzene": 2, "Ar-COOR": 2, "C=C": 2, "C=N": 2}),
        description="Ar-COOR matching for Ar-C(=O)O-N fragment.",
    ),
    SubstructMatchTest(
        id=301,
    ...
    SubstructMatchTest(
        ...
        expected_matches=Counter(
            {"Ar-C#C": 1, "Ar-COOR": 1, "Ar-C(=O)NH2": 1, "benzene": 1, "imidazole": 1}
        ),
    ...
    SubstructMatchTest(
        ...
        expected_matches=Counter(
            {"Ar-Ar": 1, "Ar-CHO": 1, "Ar-C#C": 1, "thiophene": 2}
        ),
    ),
    SubstructMatchTest(
        id=315,
        ...
        expected_matches=Counter(
            {"Ar-COOH": 1, "benzene": 1, "Ar-C#C": 1, "C=C": 1, "cyclohexene": 1}
        ),
    ...
    SubstructMatchTest(
        ...
        description="Ar-OR is not assigned for Ar-O-P fragment.",
    ),
    SubstructMatchTest(
        id=318,
    ...
    SubstructMatchTest(
        ...
        description="Ar-OR is not assigned for Ar-O-Cl fragment.",
    ),
    SubstructMatchTest(
        id=320,
        SMILES="C1=CC(=C(C=C1[N+](=O)[O-])[N+](=O)[O-])O/N=C/C2=CC(=C(C(=C2)Br)O)Br",
        expected_matches=Counter(
            {"Ar-Br": 2, "Ar-NO2": 2, "Ar-OH": 1, "Ar-OR": 1, "C=N": 1, "benzene": 2}
        ),
    ...
    # TODO Current logic supporting SMARTS excludes possibility of assigning two C=C bonds within C=C=C fragment. Fix required.
    SubstructMatchTest(
        id=361,
    ...
    SubstructMatchTest(
        ...
        expected_matches=Counter(
            {"benzene": 2, "Ar-OR": 1, "cyclobutane": 1, "R2C=N-N=CR2": 1, "Ar-C=C": 1}
        ),
    ),
    SubstructMatchTest(
        id=363,
        ...
        description="C=C=O group is matched as separate C=C and C=O bonds.",
    ),
    SubstructMatchTest(
        id=364,
        SMILES="C1=CC=C2C(=C1)C3=CC=CC=C3C2=N/N=C\\4/C5=C(C=CC(=C5)F)NC4=O",
        expected_matches=Counter(
            {"benzene": 3, "RC(=O)NH2": 1, "R2C=N-N=CR2": 1, "Ar-Ar": 1}
        ),
    ),
    SubstructMatchTest(
        id=365,
    ...
    SubstructMatchTest(
        ...
        description="RC≡C–C(=O)R matches if the adjacent carbon forms a double or triple bond. ",
    ),
    SubstructMatchTest(
        id=368,
        SMILES="C#CC(=O)O",
    ...
    # TODO Fix self-matching of RC#C-C(=O)R bond type
    SubstructMatchTest(
        id=370,
    ...
    SubstructMatchTest(
        ...
        description="RC#C-C(=O)R' is allowed to be matched if R = Si.",
    ),
    SubstructMatchTest(
        id=379,
        SMILES="C(=O)C#CI",
    ...
    SubstructMatchTest(
        ...
        expected_matches=Counter(
            {"Ar-Ar": 1, "benzene": 1, "pyrazine": 1, "pyrimidine": 1}
        ),
    ...
    SubstructMatchTest(
        ...
        expected_matches=Counter(
            {"pyrrolidine": 1, "Ar-OR": 3, "RC(=O)NH2": 1, "benzene": 1, "isoxazole": 1}
        ),
    ),
    SubstructMatchTest(
        id=391,
    ...
    SubstructMatchTest(
        ...
        expected_matches=Counter(
            {"pyrrole": 1, "triazine": 1, "benzene": 1, "Ar-Cl": 1}
        ),
    ),
    ...
    SubstructMatchTest(
        ...
        expected_matches=Counter(
            {"Ar-OR": 6, "Ar-I": 4, "Ar-Br": 5, "benzene": 3, "triazine": 1}
        ),
    ),
    SubstructMatchTest(
        id=396,
    ...
    SubstructMatchTest(
        id=398,
        SMILES="C1(C(OC2C(O1)OC(C(O2)O)O)O)O",
        expected_matches=Counter({"dioxane": 2}),
    ),
    SubstructMatchTest(
        id=399,
        SMILES="C1CN(C2=C(C(=O)N1)OC3=C2C=C(C=C3)C(F)(F)F)CC[C@H]4COCCO4",
        expected_matches=Counter(
            {"dioxane": 1, "benzene": 1, "furan": 1, "Ar-NR2": 1, "Ar-C(=O)NH2": 1}
        ),
    ),
    SubstructMatchTest(
        id=400,
